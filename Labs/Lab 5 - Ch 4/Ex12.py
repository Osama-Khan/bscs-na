...
# is 3 pieces. Finally, you ask about dividing the candy evenly among
# 7 people, and the amount left over is 2 pieces. By looking at the
# bowl, you can tell that there are less than 200 pieces. Write a
...
for i in range(1, 200):
    if i % 5 == 2 and i % 6 == 3 and i % 7 == 2:
        candies = i
        break
print(f"The jar has {candies} candies.")
